...
* [Ingress envelope](ingest.md) - The normalized Envelope every ingress source reduces to before reaching the root agent, plus its cross-port JSON wire codec for the Cloud Tasks boundary.
