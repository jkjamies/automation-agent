...
description: The distributed-tracing design — one globally registered tracer provider the agent framework inherits, four config-selected exporters, backend-aware propagation, and an in-request flush.
