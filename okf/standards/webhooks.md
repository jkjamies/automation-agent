...
per-stack examples) see [CI Integration](/standards/ci-integration.md); for the why, see
...
transparent to the routing contract above; see
[Observability (distributed tracing)](/standards/observability.md).
