...
| You want to… | Read |
|---|---|
| Understand the cloud architecture + run the GCP setup | [`okf/standards/deployment.md`](okf/standards/deployment.md) |
| Understand the **private-ingress** architecture (gateway → private Cloud Run) | [`okf/standards/deployment.md` § Private ingress](okf/standards/deployment.md#private-ingress) |
| Run the agent on your machine (env vars, run modes, container) | [`okf/standards/local-development.md`](okf/standards/local-development.md) |
| Run the tests (incl. the Firestore emulator) | [`okf/standards/testing.md`](okf/standards/testing.md) |
| Drive the lint/coverage fixers from CI | [`okf/standards/ci-integration.md`](okf/standards/ci-integration.md) |

## Setup checklist (to stand one up)

The detailed, copy-paste steps for each item are in
[`okf/standards/deployment.md`](okf/standards/deployment.md#gcp-production-setup-step-by-step).
...
Full rationale and detail for every item: [`okf/standards/deployment.md`](okf/standards/deployment.md).
...
> [`okf/standards/deployment.md` § Private ingress](okf/standards/deployment.md#private-ingress).
...
- [ ] **Phase 4 — docs + IaC.** Fold the adopted topology into `okf/standards/deployment.md`,
