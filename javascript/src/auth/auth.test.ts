 ...
 * GitHub installation token-exchange endpoint: a throwaway RSA key signs the App JWT, and
 * the stub captures it to assert RS256 / issuer / the pinned-installation path, plus
